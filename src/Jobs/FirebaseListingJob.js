...
var testFirebaseConfig_1 = require("../../__test__/env/testFirebaseConfig");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, db.collection('Listings').doc(row.id.toString())];
                case 2:
                    docRef = _a.sent();
                    return [4 /*yield*/, docRef.set(row)];
                case 3:
                    _a.sent();
...
function runJob() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var _this = this;
        return __generator(this, function (_a) {
            firebase_1.default.initializeApp(testFirebaseConfig_1.testFirebaseConfig);
